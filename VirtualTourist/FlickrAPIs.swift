...
let API_KEY = "47ab5778cf6752cd2eb7339c04b48d6d"
let EXTRAS = "url_t,url_m"
let SAFE_SEARCH = "1"
...
func getImagesFromFlickrForCoordinate(coordinate: CLLocationCoordinate2D, completion_handler: ([(String?, String, String)]?, String?) -> Void) {
    ...
    getImagesFromFlickrBySearch(methodArguments) { photos, error in
        if let error = error {
...
func getImagesFromFlickrBySearch(methodArguments: [String : AnyObject], completion_handler: ([[String: AnyObject]]?, String?) -> Void) {
            ...
            do {
                ...
                if let photosDictionary = parsedResult.valueForKey("photos") as? [String:AnyObject] {
                    ...
                    if let totalPages = photosDictionary["pages"] as? Int {
                        ...
                        getImagesFromFlickrBySearchWithPage(methodArguments, pageNumber: randomPage) { photos, error in
...
func getImagesFromFlickrBySearchWithPage(methodArguments: [String : AnyObject], pageNumber: Int, completion_handler: ([[String: AnyObject]]?, String?) -> Void) {
